...
class MoodSelectorVC: UIViewController {
    ...
    @IBAction func next(_ sender: UIButton) {
        let destVC = AppStoryboards.main.storyboardInstance.instantiateViewController(withIdentifier: "EmotionNotesVC") as! EmotionNotesVC
...
extension MoodSelectorVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {

...
class AddNewSymptomLogVC: UIViewController {
    ...
    var categories = ["Stress", "Trigger", "Physical", "Sleep", "Mood"]
    var selectedIndex = 0
    ...
    @IBAction func addLog(_ sender: UIButton) {
        let destVC = AppStoryboards.main.storyboardInstance.instantiateViewController(withIdentifier: "AddInsightVC") as! AddInsightVC
...
extension AddNewSymptomLogVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
